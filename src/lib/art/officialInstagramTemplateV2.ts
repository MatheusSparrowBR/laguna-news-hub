...
export const OFFICIAL_INSTAGRAM_TEMPLATE = { key: "hora-news-laguna-official", format: "feed" as const, width: 1080, height: 1350, logoPath: "/branding/hora-news-laguna-logo.png", logoX: 825, logoY: 1150, logoWidth: 195, logoHeight: 195 } as const;
...
export function renderOfficialInstagramSvg(input: OfficialInstagramArtInput): string {
  ...
  // A logo PNG é desenhada pelo preview/exportador como uma camada real de imagem.
  // Não é embutida no SVG para evitar que referências a assets locais desapareçam em Blob URLs.
