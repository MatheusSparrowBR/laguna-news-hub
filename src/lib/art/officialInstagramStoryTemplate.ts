...
export const OFFICIAL_INSTAGRAM_STORY_TEMPLATE = { key: "hora-news-laguna-official-story", format: "story" as const, width: DIMENSOES.story.width, height: DIMENSOES.story.height, logoPath: "/branding/hora-news-laguna-logo.png" } as const;
